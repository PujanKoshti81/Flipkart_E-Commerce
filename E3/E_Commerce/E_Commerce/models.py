...
class Special_price(models.Model):
    ...
    special_price_from = models.CharField('special_price_from', max_length=20, blank=True, null=True)
    special_price_to = models.CharField('special_price_to', max_length=20, blank=True, null=True)	
    special_price = models.CharField('special_price', max_length=10, blank=True, null=True)
    special_cost = models.CharField('special_cost', max_length=10, blank=True, null=True)
    mfr_suggested_retailer_price = models.CharField('mfr_suggested_retailer_price', max_length=10, blank=True, null=True)
    disp_actual_price = models.CharField('disp_actual_price', max_length=30, blank=True, null=True)

    sale_status = models.BooleanField(default=False)

    actual_per_gm = models.CharField('actual_per_gm', max_length=10, blank=True, null=True)
    sale_per_gm = models.CharField('sale_per_gm', max_length=10, blank=True, null=True)
    actual_total_pcs_price = models.CharField('actual_total_pcs_price', max_length=10, blank=True, null=True)
    sale_total_pcs_price = models.CharField('sale_total_pcs_price', max_length=10, blank=True, null=True)
    actual_pckg_cost = models.CharField('actual_pckg_cost', max_length=10, blank=True, null=True)
    sale_pckg_cost = models.CharField('sale_pckg_cost', max_length=10, blank=True, null=True)
    actual_parcel_cost = models.CharField('actual_parcel_cost', max_length=10, blank=True, null=True)
    sale_parcel_cost = models.CharField('sale_parcel_cost', max_length=10, blank=True, null=True)
    actual_other_cost = models.CharField('actual_other_cost', max_length=10, blank=True, null=True)
    sale_other_cost = models.CharField('sale_other_cost', max_length=10, blank=True, null=True)
    actual_total_price = models.CharField('actual_total_price', max_length=10, blank=True, null=True)
    sale_total_price = models.CharField('sale_total_price', max_length=10, blank=True, null=True)
    strike_price = models.CharField('strike_price', max_length=10, blank=True, null=True)
    strike_start = models.DateField('strike_start', blank=True, null=True)
    strike_end = models.DateField('strike_end', blank=True, null=True)
...
class Main_Image_and_Videos(models.Model):
    main_image = models.FileField(upload_to='product_images/', blank=True)
    thumbnail = models.FileField(upload_to='product_thumbanails/', blank=True)
    url_of_videos = models.FileField(upload_to='product_videos/', blank=True)

class Set_of_Images_and_Videos(models.Model):
    main_img_id = models.ForeignKey(Main_Image_and_Videos, on_delete=models.CASCADE, related_name="set_of_images_and_videos")
    url_of_images = models.FileField(upload_to='set_of_product_images/', blank=True)
    # url_of_videos = models.FileField(upload_to='set_of_product_videos/', blank=True)
...
class Basic_product_form(models.Model):
    special_price_id = models.ForeignKey(Special_price, on_delete=models.CASCADE, related_name="basic_product_form" )
    adv_inventory_id = models.ForeignKey(Pro_qty_advanced_inventory, on_delete=models.CASCADE, related_name="basic_product_form")
    contents_id = models.ForeignKey(Contents, on_delete=models.CASCADE, related_name="basic_product_form")
    main_image_id = models.ForeignKey(Main_Image_and_Videos, on_delete=models.CASCADE, related_name="basic_product_form")
    seo_id = models.ForeignKey(Search_Engine_Optimization, on_delete=models.CASCADE, related_name="basic_product_form")
    schedule_design_id = models.ForeignKey(Schedule_design_update, on_delete=models.CASCADE, related_name="basic_product_form")
    # product_prices = models.CharField('product_name', max_length=50)
    # variant_products_id = models.ForeignKey(Variant_products, on_delete=models.CASCADE, related_name="basic_product_form")
    ...
    avg_review = models.CharField('Review', max_length=3, null=True, blank=True)
    review_count = models.CharField('Review_count', max_length=3, null=True, blank=True)
